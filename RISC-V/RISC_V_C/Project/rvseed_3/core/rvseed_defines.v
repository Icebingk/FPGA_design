...
// Last Modified : 2022-04-13 04:04
// -----------------------------------------------------------------------
// Description   : 
//
//
...
`define INST_U_IMM_WIDTH 32 //没有用到
`define INST_J_IMM_WIDTH 21

// instruction bits select 指令为片区分
...
`define INST_JAL     `OPCODE_WIDTH'b1101111 // jal 唯一
`define INST_JALR    `OPCODE_WIDTH'b1100111 // jalr 唯一
`define INST_LUI     `OPCODE_WIDTH'b0110111 // lui  唯一
`define INST_AUIPC   `OPCODE_WIDTH'b0010111 // auipc    唯一
...
`define INST_SRL_SRA   `FUNCT3_WIDTH'h5 //srl/sra
...
`define INST_SRLI_SRAI `FUNCT3_WIDTH'h5 //srli/srai
