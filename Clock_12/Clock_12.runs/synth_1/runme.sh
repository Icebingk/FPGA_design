...
HD_PWD='E:/Clock_12/Clock_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_count.tcl
