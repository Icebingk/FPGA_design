...
#
# Generated by Vivado on Tue Nov 26 00:59:51 +0800 2024
...
# Script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../vivado_ad9238.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../vivado_ad9238.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
