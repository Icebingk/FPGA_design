...
// Photogate_judge Photogate_judge_m1(
// 	.rst_n                 (rst_n                      ),
// 	.pclk                  (video_clk                  ),
// 	.wave_color            (24'hffffff                 ),
// 	.adc_clk               (adc_clk_div                ),
// 	.Photogate_judge	   (Photogate_judge			   ),
// 	.adc_data			   (adc0_buf_data			   ),
// 	// .adc_buf_wr            (adc1_buf_wr                ),
// 	// .adc_buf_addr          (adc1_buf_addr              ),
// 	// .adc_buf_data          (adc1_buf_data              ),
// 	.i_hs                  (wave1_hs                   ),
...
// 	.o_vs                  (wave2_vs                   ),
// 	.o_de                  (wave2_de                   ),
// 	.o_data                ({wave2_r,wave2_g,wave2_b}  )
// );
...
//   reg datacs = 1'b1;
//   reg RDdata = 1'b1;
//   reg [11:0] dataAddr = 12'd0;

//   ADS1256  ADS1256_inst (
//     .CLK_50M(sys_clk),
//     .rst_n(rst_n),
//     .SCLK(SCLK),
//     .MOSI(MOSI),
...
wave  wave_inst (
	...
	.iRst_n(rst_n),
	.ALI(ALI),
	.oSin_clk_out(oSin_clk_out)
);

  SPWM_Time  SPWM_Time_inst (
    .sys_clk(sys_clk),
    .rst_n(rst_n),
    .ALI(ALI),
    .CLI(CLI),
